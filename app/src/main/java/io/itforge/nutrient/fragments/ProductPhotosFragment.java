...
import io.itforge.nutrient.views.splash.ISplashPresenter;
...
public class ProductPhotosFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageFront.setOnClickListener(view13 -> {
            openFullScreen(view13, mUrlImageFront);
            count = 0;
        });

        imageTwo.setOnClickListener(view1 -> {
            openFullScreen(view1, mUrlImageTwo);
            count = 1;
        });

        imageThree.setOnClickListener(view12 -> {
            openFullScreen(view12, mUrlImageThree);
            count = 2;
        });
